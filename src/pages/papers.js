...
const paperMeta = {
  'The Libra Blockchain': {
    ...
    imgLoc: '/docs/static/img/docs/libra-blockchain-pdf.png',
  ...
  'Move Programming Language': {
    ...
    imgLoc: '/docs/static/img/docs/move-language-pdf.png',
  ...
  'State Machine Replication': {
    ...
    imgLoc: '/docs/static/img/docs/state-machine-pdf.png',
